data_set <- read.csv("/home/msiddique/WSDL_Work/Breitbart_Retweet_Analysis/Graphs/carney_pattern_50.csv", header = TRUE)
...
plot(0, type='n', xlim=range(c(data_set$Start, data_set$End)), ylim=c(1, nrow(data_set)),
     xlab='Tweet Life Span', ylab='Number of Tweets', xaxt='n', yaxt='n', main = "John Carney Tweet Deletion Pattern", cex.lab = 1.5)
